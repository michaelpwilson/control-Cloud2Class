...
(function (io) {
  ...
  socket.on('connect', function socketConnected() {
    ...
    console.log("Welcome to Cloud2Class, your session id is: ", this.socket.sessionid);
...
function displayFlashActivity(message) {
  $('#chatAudio')[0].play();
  $(".navbar").after("<div class='alert alert-danger'>" + message.data.name + message.data.action + "</div>");
  $(".alert").fadeOut(5000);
}
